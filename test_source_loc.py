...
import PTVA_LI_DETERMINISTIC.source_estimation as se
import operator
...
def ptva_li_deterministic(graph, obs_time, distribution) :
    ...
    ### Run the estimation
    s_est, likelihoods = se.ml_estimate(graph, obs_time, sigma, mu, paths, path_lengths)
